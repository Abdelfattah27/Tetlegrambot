...
class AmazonScraper {
    ...
    get userAgent() {
        const os = [
            ...
            'Macintosh; Intel Mac OS X 11_0',  // Big Sur
            ...
            // Android versions
            'Linux; Android 10; SM-G975F',  // Samsung Galaxy S10
            'Linux; Android 11; Pixel 5',
            'Linux; Android 9; Pixel 3',
            'Linux; Android 8.1.0; Pixel 2 XL',
            'Linux; Android 7.1.1; Nexus 6P',
            ...
            'iPad; CPU OS 12_1 like Mac OS X',
        ];
    ...
    httpRequest({ uri, method, qs, json, body, form }) {
        ...
        qs= {...qs } //  , p_6: 'A1ZVRGNO5AYLOV' , rh:'p_n_availability%3A21909181031'
    ...
    sortAndFilterResult() {
        ...
        if (this.scrapeType === 'products') {
            ...
            this.collector.sort((a, b) =>{ 
                // console.log(a.price)
            return     b.price.savings_percent - a.price.savings_percent
            });
    ...
    grabAsinDetails(body) {
        ...
        output.seller = this.extractSeller($)
        ...
        output.item_available = $('#outOfStock').text() ? false : true;
    ...
    extractSeller($){
        const moreBuyingOptions = $('#sellerProfileTriggerId')[0];
        if (moreBuyingOptions) {
            return false
        }else {
            return true
        }
        // console.log("hello" ,moreBuyingOptions)
    }
